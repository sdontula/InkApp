...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //SISkuData *sku1 = [[SISkuData alloc] initWithDesc:@"134858" description:@"Paper"];
    //SISkuData *sku2 = [[SISkuData alloc] initWithDesc:@"512343" description:@"Ink"];
    //NSMutableArray *skus = [NSMutableArray arrayWithObjects:sku1, sku2, nil];
